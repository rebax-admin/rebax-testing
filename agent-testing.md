...
| S.No | TestCase | Status | Notes |
|:--:|:--|:--:|:--|
|1|Click on personal info and to the page, only address, State, city and pincode should be editable rest should un-editable, Check if the editable fields are saving |||
### Agent Professional ID's
| S.No | TestCase | Status | Notes |
|:--:|:--|:--:|:--|
|1|Click on professional ID's and go to the page, only RERA ID should be editable if it is not already added, If already added it should also be un-editable |||
